"""
pipeline.py - RAG pipeline initialisation for DipeshBot
======================================================
Shared pipeline builder used by both CLI (main.py) and API server (api_server.py)
"""
...
def initialise_pipeline(data_dir: str = "data", rebuild: bool = False):
    ...
    logger.info("=" * 60)
    logger.info("  DIPESHBOT - Portfolio AI Assistant - Starting up")
    logger.info("=" * 60)
